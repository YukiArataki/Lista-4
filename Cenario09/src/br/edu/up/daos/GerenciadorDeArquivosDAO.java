...
import br.edu.up.modelos.ClienteEmpressa;
import br.edu.up.modelos.ClientePessoa;

public class GerenciadorDeArquivosDAO {

    private String header = "";
    private String nomeDoArquivo = "C:\\ws_\\Cenario09\\src\\clientes.csv";
        ...
        try{
            ...
            while (leitor.hasNextLine()) {
                ...
                if (cpf != null && !cpf.equals("")){
                    ...
                    cliente = new ClienteEmpressa(nome, telefone, email, cnpj, iestadual, ano);
                    listaDeClientes.add(cliente);                 
                }
            }
    ...
    public void gravarAquivo(){
        ...
        String header = "";
        String nomeDoArquivo = "C:\\ws_\\Cenario09\\src\\clientes.csv";
        List<Cliente> listaDeClientes = new ArrayList<>();
